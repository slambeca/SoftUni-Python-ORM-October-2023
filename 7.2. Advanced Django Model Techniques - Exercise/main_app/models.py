...
from main_app.validators import validate_name, check_age
...
class Customer(models.Model):
    ...
    age = models.PositiveIntegerField(
        ...
        # or by using MinValueValidator and passing 18 as first parameter
    )
    ...
    phone_number = models.CharField(
        max_length=13,
        validators=[RegexValidator(regex=r'^\+359\d{9}$', message="Phone number must start with a '+359' "
